...
enum ErrorUnit
{
  ...
  EU_BYTE,
  EU_PKT,
  //This latter value is tightly linked to the HiddenMarkovErrorModel, defining how the time basis simulation is carried out.
  EU_TIME
};
...
private:
	...
	bool m_isCorrect;				//Flag that forces a frame to be correctly received
