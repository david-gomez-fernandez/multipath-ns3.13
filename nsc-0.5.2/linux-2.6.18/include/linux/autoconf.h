...
#define CONFIG_X86 1
/*
 * Note: Setting CONFIG_64BIT and CONFIG_X86_64 is not needed when
 * building a 64 bit library; it makes no difference in our case.
 */
#define CONFIG_MMU 1
...
#define CONFIG_FLAT_MODE_MEM_MAP 1
