...
int main(int argc, char *argv[])
{
  ...
  if(arg3 == 2)
    ...
    //LogComponentEnable("ipv4", LOG_ALL);
...
///////////Pablo////////////////////////////
    ...
    stack.Install (nodes);
  	...
  	string fileName="tcpTopology-traces.tr";
    ...
    for (int i=0; i < (int) NodeList::GetNNodes(); i++)
    {
    	...
    	if(mp)
    	{
    	  mp->SetMpTraceCallback (MakeCallback (&ProprietaryTracing::DefaultMpTcpRxTrace, pTracing));
    	}
    }
...
//        p2plink.EnablePcap ("prueba" , nodes, true);
        p2plink.EnableAscii ("prueba", nodes);
    }
/*
